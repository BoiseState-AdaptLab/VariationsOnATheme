...
Real** mini_flux_div_explain(Real** old_boxes,Real** new_boxes,
...
int main(int argc, char **argv){
  ...
  **************************************************************************/
  ...
  mini_flux_div_explain(old_boxes,new_boxes,config,measurements);  
...
Real** mini_flux_div_explain(Real** old_boxes,Real** new_boxes,
  ...
  // number of faces in each direction.
   Real* g_cache = (Real*)malloc(sizeof(Real)*numCell*numCell*(numCell+1)*numComp);
