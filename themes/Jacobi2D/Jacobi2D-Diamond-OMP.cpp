 ...
 *
 * Modified version of Jacobi2D-DiamondSwap-OMP.cpp. In this version, we swap
 * k1 and k2 loops.
 *
 * Usage:
 *  make omp
 *  ./Jacobi2D-Diamond-OMP --Nx 5000 --Ny 5000 -T 50 --num_threads 8
 * For a run on 8 threads
 *
 * To see possible options:
 *  ./Jacobi2D-Diamond-OMP --help
 *
******************************************************************************/
/****************************************************************************
 *
