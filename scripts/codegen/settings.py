...
''',
    ...
    'build': {
        ...
        'COPTS': '-fopenmp -O4', # -DTILE_SIZE=16',
...
graphs = {
    'seriesSSACLO': {
        'comps': ['p', 'e', 'u', 'v', 'w'],
        'nodes': [
            [('T','N^3'), ('T','N^3'), ('T','N^3'), ('T','N^3'), ('T','N^3')],                                  #  0
            [('S','Fx1'), ('S','Fx1'), ('S','Fx1'), ('S','Fx1'), ('S','Fx1')],                                  #  1
            [('D','N^3+N^2'), ('D','N^3+N^2'), ('D','N^3+N^2'), ('D','N^3+N^2'), ('D','N^3+N^2')],    #  2
            [('S','Fx2'), ('S','Fx2'), ('S','Fx2'), ('S','Fx2'), ('S','Fx2')],                                  #  3
            [('D','N^3+N^2'), ('D','N^3+N^2'), ('D','N^3+N^2'), ('D','N^3+N^2'), ('D','N^3+N^2')],    #  4
            [('S','Dx'), ('S','Dx'), ('S','Dx'), ('S','Dx'), ('S','Dx')],                                       #  5
            [('S','Fy1'), ('S','Fy1'), ('S','Fy1'), ('S','Fy1'), ('S','Fy1')],                                  #  6
            [('D','N^3+N^2'), ('D','N^3+N^2'), ('D','N^3+N^2'), ('D','N^3+N^2'), ('D','N^3+N^2')],    #  7
            [('S','Fy2'), ('S','Fy2'), ('S','Fy2'), ('S','Fy2'), ('S','Fy2')],                                  #  8
            [('D','N^3+N^2'), ('D','N^3+N^2'), ('D','N^3+N^2'), ('D','N^3+N^2'), ('D','N^3+N^2')],    #  9
            [('S','Dy'), ('S','Dy'), ('S','Dy'), ('S','Dy'), ('S','Dy')],                                       # 10
            [('S','Fz1'), ('S','Fz1'), ('S','Fz1'), ('S','Fz1'), ('S','Fz1')],                                  # 11
            [('D','N^3+N^2'), ('D','N^3+N^2'), ('D','N^3+N^2'), ('D','N^3+N^2'), ('D','N^3+N^2')],    # 12
            [('S','Fz2'), ('S','Fz2'), ('S','Fz2'), ('S','Fz2'), ('S','Fz2')],                                  # 13
            [('D','N^3+N^2'), ('D','N^3+N^2'), ('D','N^3+N^2'), ('D','N^3+N^2'), ('D','N^3+N^2')],    # 14
            [('S','Dz'), ('S','Dz'), ('S','Dz'), ('S','Dz'), ('S','Dy')],                                       # 15
            [('T','N^3'), ('T','N^3'), ('T','N^3'), ('T','N^3'), ('T','N^3')]                                   # 16
        ],
